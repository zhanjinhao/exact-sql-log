...
public class EslStatementExecuteInterceptor implements Interceptor {

  private static final SystemLogger log =
          AgentDefaultSystemLoggerFactory.getInstance().getSystemLogger(EslStatementExecuteInterceptor.class);
  ...
  public Object intercept(
    ...
    log.info("EslStatementExecuteInterceptor.class.classLoader = {}.", this.getClass().getClassLoader());

    EntryPoint entryPoint = EntryPoint.of(EntryPointType.REMOTE_JDBC,
